    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <?php
              session_start();if (isset($_SESSION['type'])) { 
                ...
                echo "<li><a href='php/logout.php'>Deconnexion</a></li>";
              } 
            ?>
        </ul>
      </nav>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/img/Fotolia.jpg');">
      <div class="container position-relative d-flex flex-column align-items-center">
        ...
        <h2>Accueil</h2>
        <ol>
            <li><a href="index.php">ChrisTravelAgence</a></li>
            <li>C'est nous</li>
        </ol>
...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="assets/img/par.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
      <h5>Témoignage de Jules</h5>
    ...
    <div class="carousel-item">
      <img src="assets/img/pi.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>Témoignage de Lou</h5>
    ...
    <div class="carousel-item">
      <img src="assets/img/pas.jpeg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
      <h5>Témoignage de Bradley</h5>
        <p>"ChrisTravelAgence est tout simplement la meilleure agence! Je vous la recommande personnellement."</p>
      </div>
    </div>
  </div>
